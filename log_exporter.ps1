# Getting API Keys from https://ipgeolocation.io/
$API_KEY      = "ad80be803b1644c89e3c4b86afb4d88a"

# Saving Log File in ProgramData
$LOGFILE_NAME = "failed_rdp.log"
$LOGFILE_PATH = "C:\ProgramData\$($LOGFILE_NAME)"

# Filtering and choosing only failed RDP events
$XMLFilter = @'
<QueryList> 
